...
{1015,16,86,61,44,63,80,48,25,15,30,45,36},
   ...
   System.out.println("-----------------------------------------------------");
       ...
       ch = sc.nextInt(); //Enter choice from user
       switch(ch)
       {
       case 1 -> {
           int flag = 0;
           System.out.println("Enter account number = ");
           int account = sc.nextInt(); // get account number from user
           for (int i = 0; i < payments.length; ++i) {
               for(int j = 0; j < 1; ++j) {
                   //check account no is present in array
                   if(payments[i][j] == account){
                       //print customer details
                       System.out.println("-----------------------------------------------------");
                       System.out.println("Customer payment history");
                       System.out.println("-----------------------------------------------------");
                       System.out.print(customers[i]+" "); //customer name
                       System.out.print(payments[i][j]+" "); //customer account number
                       int count = 0;
...
//if account number not find show below message
if(flag == 0)
{
    System.out.println("Not find account number...!! ");
       ...
       case 2 -> {
           ...
           for (int i = 0; i < payments.length; ++i) {
               ...
               if(count1 > 2) //zero is more than two
               {
                   //customer details
                   System.out.print(customers[i]+" "); //customer name
                   System.out.print(payments[i][0]+" "); //customer account number
                   for(int k = 1; k < payments[i].length; ++k) {
                       System.out.print(payments[i][k]+" "); //Monthly Payment
                   }
               ...
               else if(count1 == 1) //zero is equal to one
               {
                   //customer details
                   System.out.print(customers[i]+" "); //customer name
                   System.out.print(payments[i][0]+" "); //customer account number
...
//if No Closed Payments show below message
if(flag2 == 0)
{
